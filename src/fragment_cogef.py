        ...
        while stationary_cycles <= args.max_stationary_cycles:
            ...
            while instab_cycles <= args.max_instab_cycles:
                ...
                with open(filename+".com", "w") as of:
                    if args.fragment_guess:
                        data.write_input_fragment_guess(of,modredundant=["{} {} F".format(args.atoms[0],args.atoms[1])],fragment=args.fragment,route_args=opt_args)
                    else:
                        data.write_input(of,modredundant=["{} {} F".format(args.atoms[0],args.atoms[1])], instability=instab, route_args=opt_args)
